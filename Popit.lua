...
local Window  = Library.CreateLib("Script By romoneand", "Midnight")
...
local Section = Tab:NewSection("This Script Is Made By romoneand")

local Section = Tab:NewSection("Discord: romlnwza007#3770")
